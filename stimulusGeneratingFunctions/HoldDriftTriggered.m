function stimulusInfo = HoldDriftTriggered(randMode, hz, screenRect, window,  preDriftHoldTime, directionsNum, spaceFreqPixels, tempFreq, gratingtex, repeats, inputLine, inputPort, deviceName, photoDiodeRect)
%HOLDDRIFTTRIGGERED displays a stationary grating for a defined time, then
% a moving grating until a trigger
%
%Inputs:
%
% Randomisation Mode; Screen refresh rate; Screen Size (as rect); Window
% Pointer; Predrift hold time; Number of directions; the spatial
...
stimulusInfo.experimentType = 'HD';
...
for repeat = 1:repeats
    for d=1:directionsNum
        ...
        for frameCount= 1:round(preDriftHoldTime * hz);
        ...
        %Drift until terminated by a trigger
