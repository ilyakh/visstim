function stimulusInfo = HoldDrift( randMode, hz, screenRect, window, baseLineTime,preDriftHoldTime,driftTime,  directionsNum, spaceFreqPixels, tempFreq, gratingtex, repeats, photoDiodeRect)
...
% Pointer; Baseline recording time; preDrift hold time; Drift time;  Number
